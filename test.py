...
# print(response_data['features'][0]['properties'])
# Output: 231 Forest St

latitude = response_data['features'][1]['geometry']['coordinates'][1]
longitude = response_data['features'][1]['geometry']['coordinates'][0]
